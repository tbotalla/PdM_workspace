#### Practica 2
La resolución de la práctica se encuentra dentro de [Core/Src/main.c](Core/Src/main.c) y [Core/Inc/main.h](Core/Inc/main.h).
...
Sí, se pueden cambiar en un solo lugar. Los tiempos no están repartidos por el código: están todos en el arreglo `tick_patterns[]` en [main.c](Core/Src/main.c). 
...
Agregadas explícitamente: en [main.h](Core/Inc/main.h) solo está `#include <stdbool.h>` (para `bool_t`).
Convendría ponerlas en un único lugar común, por ejemplo en [main.h](Core/Inc/main.h) (o en un header de tipos del proyecto) y que el resto de archivos incluya ese header en lugar de repetir includes.
...
No demasiado. Para que sea reutilizable habría que extraer la lógica principal a una función que reciba todos los parámetros necesarios en vez de tener todo en [main.c](Core/Src/main.c).

##### 5. ¿Cuán sencillo es cambiar el patrón de tiempos de parpadeo?
Fácil, basta con editar el arreglo `tick_patterns[]` en [main.c](Core/Src/main.c): agregar o quitar filas, o cambiar `period_ms`, `count` o `duty_cycle`. 
